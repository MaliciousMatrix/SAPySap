...
class AvailabilityGetter:
    ...
    def sunday(start_hour, end_hour, start_minute=0, end_minute=0):
        return AvailabilityGetter._get(1, start_hour, end_hour, start_minute, end_minute)

    def monday(start_hour, end_hour, start_minute=0, end_minute=0):
        return AvailabilityGetter._get(2, start_hour, end_hour, start_minute, end_minute)

    def tuesday(start_hour, end_hour, start_minute=0, end_minute=0):
        return AvailabilityGetter._get(3, start_hour, end_hour, start_minute, end_minute)

    def wednesday(start_hour, end_hour, start_minute=0, end_minute=0):
        return AvailabilityGetter._get(4, start_hour, end_hour, start_minute, end_minute)

    def thursday(start_hour, end_hour, start_minute=0, end_minute=0):
        return AvailabilityGetter._get(5, start_hour, end_hour, start_minute, end_minute)

    def friday(start_hour, end_hour, start_minute=0, end_minute=0):
        return AvailabilityGetter._get(6, start_hour, end_hour, start_minute, end_minute)

    def saturday(start_hour, end_hour, start_minute=0, end_minute=0):
        return AvailabilityGetter._get(7, start_hour, end_hour, start_minute, end_minute)

    def _get(day, start_hour, end_hour, start_minute, end_minute):
        generic = CommonTestFunctions()
        return generic.camp_availability(day, start_hour, end_hour, start_minute, end_minute)